...
const hoursData = {
    ...
    3: { o: 10, c: 18 },  // Wednesday: 10 AM - 6 PM
    4: { o: 10, c: 19 },  // Thursday: 10 AM - 7 PM
    5: { o: 10, c: 19 },  // Friday: 10 AM - 7 PM
    6: { o: 10, c: 16 }   // Saturday: 10 AM - 4 PM
};

// One-off overrides for specific dates (e.g., special hours, single-day closures)
const overrides = {
    "2026-12-25": { hours: null, reason: "Christmas Day" },
    "2026-12-26": { hours: null, reason: "St. Stephen's Day" },
    "2027-01-01": { hours: null, reason: "New Year's Day" },
    "2026-12-24": { hours: { o: 10, c: 14 }, reason: "Christmas Eve" },
};

// Temporary closures for a date range (e.g., holidays)
const temporaryClosures = [
    { start: "2026-12-27", end: "2026-12-29", reason: "Christmas Holidays" }
];
